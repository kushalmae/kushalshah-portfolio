...
const experience = [
  {
    ...
    bullets: [
      ...
      "Build, test, and deploy Docker containers for ground software and mission-ops tooling — image hardening, integration testing, and rehearsal validation across ground and flight software stacks.",
